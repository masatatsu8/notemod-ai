...
import { Upload, Download, Wand2, Loader2, FileUp, Eraser, Archive, Pencil } from 'lucide-react';
        ...
        {fileName && (
             <>
                ...
                <button 
                    ...
                    disabled={isProcessing}
                    className={`flex items-center gap-2 px-4 py-2 rounded-md text-white shadow-sm transition-all ${
                        isProcessing 
