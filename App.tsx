...
import { generateModifiedPage } from './services/geminiService';
    ...
    <div className="flex flex-col h-screen w-full bg-gray-50">
      ...
      <div className="flex flex-1 overflow-hidden">
        {state.pages.length > 0 ? (
          ...
          >
             <div 
                className={`bg-white p-12 rounded-2xl shadow-sm border-2 transition-all flex flex-col items-center text-center max-w-md mx-auto w-full ${
                    isDragging 
             ...
             >
                 <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-6 transition-colors ${
                     isDragging ? 'bg-brand-100 text-brand-600' : 'bg-brand-50 text-brand-500'
                 }`}>
                    <UploadCloud size={32} />
                 </div>
                 ...
                 <button 
                    ...
                    className={`bg-brand-600 hover:bg-brand-700 text-white px-6 py-3 rounded-lg font-medium transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 ${
